...
spa.shell = (function () {
  'use strict';
		...
		for ( key_name in arg_map ) {
			if ( arg_map.hasOwnProperty( key_name ) ) {
				...
				if ( arg_map [key_name_dep] ) {
					anchor_map_revise[key_name_dep] 
						= arg_map[key_name_dep];
				}
				else {
	...
	onTapAcct = function(event) {
	  ...
	  if (user.get_is_anon()) {
	    var user_name = prompt('Please sign in');
	...
	// Purpose   : Directs the shell to offer its capability to user
	// Arguments :
	//   * $container - A jQuery collection that should represent
	...
	initModule = function( $container ) {
		var $template = $('#spa-shell-template');
		var context = { title: 'SPA' };
		...
		// and initialized, otherwised they will not be ready to
